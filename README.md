...
- MPU6050            : contains the driver to handle the gyroscope and accelerometer and combine them. The author of this library is Bulanov Konstantin and you can check their github repo with this link
